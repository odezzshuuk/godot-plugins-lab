...
public static class Constants {
  ...
  public const string MAIN_PANEL_SCENE_PATH = PLUGIN_DIR_PATH + "scenes/panel.tscn";
  public const string MAIN_PANEL_INSTANCE_PATH = SCENE_INSTANCE_DIR_PATH + "panel.tscn";
